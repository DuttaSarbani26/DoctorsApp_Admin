...
//   { label: "Departments", path: "/dashboard/departmentList", icon: <LocalHospitalIcon /> },
//   { label: "Doctors", path: "/dashboard/doctors", icon: <GroupsIcon /> },
//   { label: "Appointments", path: "/dashboard/appointment", icon: <EventNoteIcon /> },
// ];
...
//                   boxShadow: active ? "0 4px 15px rgba(124,58,237,0.3)" : "none",
...
const menuItems = [
  ...
  { label: "Doctors", path: "/dashboard/doctors", icon: <GroupsIcon /> },
  { label: "Appointments", path: "/dashboard/appointment", icon: <EventNoteIcon /> },
  { label: "Location", path: "/dashboard/location", icon: <LocationOnIcon /> }, // ✅ NEW MENU
];
